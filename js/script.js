...
function appendTaskDOM(tarea) {
  ...
  // Controlador - Evento para ocultar las tareas completas.
  const tareascompletas = document.getElementById('hide-completed');
  tareascompletas.addEventListener('click', (event) =>{
    const completas = event.currentTarget.checked;
    taskocultos(completas);
  });
...
function taskocultos(completas) {
